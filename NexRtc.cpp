...
bool NexRtc::read_rtc_time(char *time,uint32_t len)
{
    ...
    cmd = "get rtc0";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&year);
    
    cmd = "";
    cmd = "get rtc1";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&mon);
    
    cmd = "";
    cmd = "get rtc2";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&day);
    
    cmd = "";
    cmd = "get rtc3";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&hour);
    
    cmd = "";
    cmd = "get rtc4";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&min);
    
    cmd = "";
    cmd = "get rtc5";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&sec);
    
    cmd = "";
    cmd = "get rtc6";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&week);
...
bool NexRtc::read_rtc_time(uint32_t *time,uint32_t len)
{
    ...
    cmd = "get rtc0";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&time_buf[0]);
    
    cmd = "";
    cmd = "get rtc1";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&time_buf[1]);
    
    cmd = "";
    cmd = "get rtc2";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&time_buf[2]);
    
    cmd = "";
    cmd = "get rtc3";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&time_buf[3]);
    
    cmd = "";
    cmd = "get rtc4";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&time_buf[4]);
    
    cmd = "";
    cmd = "get rtc5";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&time_buf[5]);
    
    cmd = "";
    cmd = "get rtc6";
    sendCommand(cmd.c_str());
    success &= recvRetNumber(&time_buf[6]);
